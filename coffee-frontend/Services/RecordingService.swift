...
enum RecordingService {
    ...
    static func uploadMedia(
        ...
        let url = URL(string: "https://api-coffee.up.railway.app/api/v1\(APIEndpoints.gravacaoMedia(id: recordingId))")!
    ...
    static func getSummaryPDFURL(recordingId: String) -> URL? {
        URL(string: "https://api-coffee.up.railway.app/api/v1\(APIEndpoints.gravacaoPdfResumo(id: recordingId))")
    }

    /// Get mind map PDF URL for download
    static func getMindMapPDFURL(recordingId: String) -> URL? {
        URL(string: "https://api-coffee.up.railway.app/api/v1\(APIEndpoints.gravacaoPdfMindmap(id: recordingId))")
    }
